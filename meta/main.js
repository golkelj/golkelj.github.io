...
function processCommits(data) {
  return d3
    ...
    .map(([commit, lines]) => {
      ...
      let ret = {
        id: commit,
        url: 'https://github.com/golkelj/golkelj.github.io/commit/' + commit,
        author,
        date,
        time,
        timezone,
...
function renderScatterPlot(data, commits) {
  ...
  // Sort commits by total lines in descending order (so smaller dots are on top)
  ...
  dots
    ...
    .attr('fill', (d) => {
      // Color based on time of day - bluer for night, orangish for daytime
